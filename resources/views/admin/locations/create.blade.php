                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" name="is_airport">
                                        <label class="form-check-label">Aeropuerto</label>
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-12 text-right">
                                    <button type="submit" class="btn btn-primary purple">Guardar Ubicación</button>
                                </div>
                            </div>
                        </form>
                    </div>
