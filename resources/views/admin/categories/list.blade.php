                    ...
                    <div class="card-body">
                        <div class="row mb-3">
                            <div class="col-12 text-right">
                                <a href="{{ route('admin.categories.create') }}" class="btn btn-primary purple">Crear Categoría</a>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        @foreach($categories as $category)
                                            <tr>
                                                <td>{{ $category->name }}</td>
                                                <td>{{ $category->isAvailable() ? 'Si' : 'No' }}</td>
                                                <td><a href="{{ route('admin.categories.show', $category->id) }}" class="btn btn-primary purple">Ver detalle</a></td>
                                                <td><a href="{{ route('admin.categories.eliminar', $category->id) }}" class="btn btn-danger">Eliminar</a></td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                </table>
